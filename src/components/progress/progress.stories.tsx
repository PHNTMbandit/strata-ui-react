...
export default {
  ...
  render: (args) => (
    <Progress {...args} className="w-[300px]">
      <ProgressIndicator description="This is the first step" title="First Step">
        1
      </ProgressIndicator>
      <ProgressBar />
      <ProgressIndicator description="This is the second step" isActive title="Second Step">
        2
      </ProgressIndicator>
      <ProgressBar />
      <ProgressIndicator description="This is the third step" title="Third Step">
        3
      </ProgressIndicator>
    </Progress>
  ),
...
export const DefaultWithIcon: Story = {
  render: (args) => (
    <Progress {...args} className="w-[300px]">
      ...
      <ProgressBar />
      <ProgressIndicator description="This is the second step" title="Second Step">
        <CheckIcon weight="bold" />
      </ProgressIndicator>
      <ProgressBar />
      <ProgressIndicator description="This is the third step" isActive title="Third Step">
        <CheckIcon weight="bold" />
      </ProgressIndicator>
    </Progress>
  ),
