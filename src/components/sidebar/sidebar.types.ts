...
export const sidebarMenuLinkVariants = cva(
	"group inline-flex items-center justify-between rounded-xl px-sm text-on-surface transition-[margin] transition-colors b hover:bg-surface-container-mid not-active:hover:shadow-sm hover:cursor-pointer not-active:hover:text-on-surface active:inset-shadow-sm active:bg-surface-dim data-active:pointer-events-none data-active:text-primary shrink-0",
	{
		variants: {
			size: {
				full: "w-full h-xl",
