...
export const sidebarMenuLinkVariants = cva(
	"group inline-flex items-center justify-between rounded-xl px-sm text-on-surface transition-all hover:inset-shadow-raised-sm not-active:hover:shadow-sm hover:cursor-pointer hover:bg-surface-bright not-active:hover:text-on-surface active:inset-shadow-sm active:bg-surface-dim data-active:pointer-events-none data-active:text-primary shrink-0",
	{
		variants: {
			size: {
				full: "w-full h-xl",
...
export const sidebarSubMenuTriggerVariants = cva(
	"group inline-flex items-center justify-between rounded-xl px-sm text-on-surface transition-all hover:inset-shadow-raised-sm [&:not([data-panel-open])]:not-active:hover:shadow-sm hover:cursor-pointer hover:bg-surface-bright not-active:hover:text-on-surface active:inset-shadow-sm active:bg-surface-dim data-panel-open:bg-surface-dim data-panel-open:text-on-surface data-panel-open:inset-shadow-sm shrink-0",
	{
		variants: {
			size: {
				full: "w-full h-xl",
