...
export const breadcrumbVariants = cva('flex items-center gap-2xs px-sm py-2xs', {
  variants: {
    style: {
      ghost: '',
      solid: '',
...
export interface BreadcrumbProps
  extends Omit<ComponentProps<'div'>, 'style'>, VariantProps<typeof breadcrumbVariants> {
