	...
	if (orientation === "vertical") {
		return (
			<SwitchTabs.Indicator
				className={cn(
					"absolute inset-shadow-raised-md left-1/2 z-[-1] h-(--active-tab-height) w-(--active-tab-width) -translate-x-1/2 translate-y-(--active-tab-top) rounded-full bg-primary shadow-md transition-all duration-300 ease-[cubic-bezier(0.68,-0.55,0.27,1.55)]",
					className,
				)}
				{...props}
			/>
