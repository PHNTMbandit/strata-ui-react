    ...
    compoundVariants: [
      {
        size: 'small',
        shape: 'rounded',
        className: '[&_[role=tablist]]:rounded-md [&_[role=presentation]]:rounded-md',
      },
      {
        size: 'medium',
        shape: 'rounded',
        className: '[&_[role=tablist]]:rounded-lg [&_[role=presentation]]:rounded-lg',
      },
      {
        size: 'large',
        shape: 'rounded',
        className: '[&_[role=tablist]]:rounded-xl [&_[role=presentation]]:rounded-xl',
      },
    ],
  },
)
...
export interface TabsProps
  extends
    Omit<ComponentProps<typeof BaseTabs.Root>, 'style' | 'orientation'>,
