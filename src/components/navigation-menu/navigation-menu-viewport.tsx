		...
		<BaseNavigationMenu.Portal>
			...
			>
				<BaseNavigationMenu.Popup
					className={cn(
						"data-[ending-style]:easing-[ease] relative inset-shadow-raised-lg w-fit origin-(--transform-origin) rounded-xl border border-outline bg-surface-container shadow-lg outline outline-outline-variant transition-[opacity,transform,scale] duration-(--duration) ease-(--easing) data-ending-style:scale-90 data-starting-style:scale-90 data-ending-style:opacity-0 data-starting-style:opacity-0 data-ending-style:duration-150",
					)}
				>
