...
export type NavigationMenuItemProps = React.ComponentProps<typeof BaseNavigationMenu.Item>
...
export type NavigationMenuViewportProps = React.ComponentProps<typeof BaseNavigationMenu.Positioner>
