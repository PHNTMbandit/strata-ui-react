  ...
  return (
    <div className="flex items-center gap-xs">
      ...
      >
        <BaseSwitch.Thumb
          className={
            "elevation-xs size-[12px] translate-x-[8px] rounded-full bg-accent shadow-xs transition-transform duration-500 ease-[cubic-bezier(0.68,-0.55,0.27,1.55)] data-checked:size-[16px] data-checked:translate-x-[28px] data-checked:scale-[1.1] data-checked:bg-on-accent data-unchecked:bg-accent"
          }
        />
      </BaseSwitch.Root>
